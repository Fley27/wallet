...
import {getItemCreditDetail} from "../../../data/data";
import Delete from "../../../component/deleteconfirmation";

const Detail = ({navigation}) => {
    const {amount, device, date, lender, phone, email, status, paidAt, subStatus, expectedDate} = getItemCreditDetail;
            ...
            <View style = {styles.container}>
                <View style = {styles.headerContainer}>
                    ...
                    <View style = {styles.header}>
                        ...
                        <View style = {styles.amountContainer}>
                            <Text style = {styles.textLabel}>{lender}</Text>
                        </View>
                    </View>
                    <View style = {styles.header}>
                        <View style = {styles.labelContainer}>
                    ...
                    <View style = {styles.header}>
                        ...
                        <View style = {styles.amountContainer}>
                            ...
                            <View style = {[styles.statusCircle, styles.device, {marginLeft: 5},
                                ...
                                subStatus === true && status === false ? {backgroundColor: "rgb(245, 120, 66)"}: 
                                subStatus === false && status === false ? {backgroundColor: "rgb(214, 13, 50)"} : null]}></View>
                        </View>
                    </View>
                    <View style = {styles.header}>
                        <View style = {styles.labelContainer}>
